...
tweetTxt = open('a2.txt' , 'r') # Tweet input text
...
centerTxt = open('a2init.txt' , 'r') # Text file containing IDs of initial selection of centroids
centroid = [] # This stores the IDs of the centroids
for line in centerTxt:
	centroid.append(int(line[:len(line)-2])) # Read each ID in integer form into the centroid list
centerTxt.close()
